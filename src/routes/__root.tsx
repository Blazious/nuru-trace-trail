  ...
  head: () => ({
    meta: [
      ...
      { title: "NuruTrace Labs — Blockchain Intelligence for Africa" },
      {
        name: "description",
        content:
          "Forensics, compliance, and intelligence for law enforcement, financial institutions, and legal professionals across Kenya and Africa.",
      },
      { name: "author", content: "NuruTrace Labs" },
